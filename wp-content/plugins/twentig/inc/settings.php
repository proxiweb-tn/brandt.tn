...
/**
 * Display a checkbox field for openverse.
 */
function twentig_openverse_render() {
	$value = twentig_is_option_enabled( 'openverse' );
	?>
	<input type="hidden" name="twentig-options[openverse]" value="0" />
	<label for="openverse">
		<input type="checkbox" name="twentig-options[openverse]" id="openverse" <?php checked( 1, $value ); ?> value="1"> 
		<?php esc_html_e( 'Enable Openverse', 'twentig' ); ?>
	</label>
	<?php
}
